  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `form_data` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `formId` TEXT, `formTitle` TEXT, `fieldName` TEXT, `fieldValue` TEXT, `inserted_on` INTEGER NOT NULL DEFAULT 0, `synced` INTEGER NOT NULL DEFAULT 0, `synced_on` INTEGER NOT NULL DEFAULT 0)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'e4ce2927d2056d1d46ecace5758257f9')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsFormData = new HashMap<String, TableInfo.Column>(8);
        ...
        _columnsFormData.put("inserted_on", new TableInfo.Column("inserted_on", "INTEGER", true, 0, "0", TableInfo.CREATED_FROM_ENTITY));
        _columnsFormData.put("synced", new TableInfo.Column("synced", "INTEGER", true, 0, "0", TableInfo.CREATED_FROM_ENTITY));
        _columnsFormData.put("synced_on", new TableInfo.Column("synced_on", "INTEGER", true, 0, "0", TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "e4ce2927d2056d1d46ecace5758257f9", "9e4c78613dd5a654f2555daa60cc9545");
